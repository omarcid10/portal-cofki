...
module.exports = [
  ...
  {
    id: 'inventarios-semanales',
    name: 'Inventarios Semanales',
    description: 'Conteo de inventario total semanal, automatizado para carga en Parrot',
    url: 'https://cofki-inventarios-semanales.netlify.app/',
    minTier: 'equipo',
  },
  {
    id: 'checklist-apertura-cierre',
    name: 'Checklist de Apertura y Cierre',
    description: 'Registro de apertura y cierre de sucursal',
    url: 'https://checklist-apertura-cierre.netlify.app/',
    minTier: 'equipo',
  },
  {
    id: 'reservas',
